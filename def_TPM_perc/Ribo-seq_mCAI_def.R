...
dir.create(paste0("picture_riboseq_bymCAI",exp))
dir.create(paste0("correlation_riboseq_bymCAI",exp))
...
for (i in ribo_array) {
  ...
  #===========================================================================
  svg(file=paste0("/media/hp/disk1/DYY/reference/annotation/", species,"/picture_riboseq_bymCAI",exp,"/",name,"_CAI_TPM.svg"))
  ...
  #===========================================================================
  svg(file=paste0("/media/hp/disk1/DYY/reference/annotation/", species,"/picture_riboseq_bymCAI",exp,"/","TOP1_",name,"_CAI_TPM.svg"))
  ...
  #===========================================================================
  svg(file=paste0("/media/hp/disk1/DYY/reference/annotation/", species,"/picture_riboseq_bymCAI",exp,"/","h_",name,"_CAI_TPM.svg"))
  ...
  #===========================================================================
  svg(file=paste0("/media/hp/disk1/DYY/reference/annotation/", species,"/picture_riboseq_bymCAI",exp,"/","l50_",name,"_CAI_TPM.svg"))
  ...
  #===========================================================================
  svg(file=paste0("/media/hp/disk1/DYY/reference/annotation/", species,"/picture_riboseq_bymCAI",exp,"/","def_",name,"_CAI_TPM.svg"))
  ...
  #===============================================================================
  svg(file=paste0("/media/hp/disk1/DYY/reference/annotation/", species,"/picture_riboseq_bymCAI",exp,"/","half_",name,"_CAI_TPM.svg"))
  ...
  #===============================================================================
  svg(file=paste0("/media/hp/disk1/DYY/reference/annotation/", species,"/picture_riboseq_bymCAI",exp,"/","test50_",name,"_CAI_TPM.svg"))
  ...
  write.table(paste(CAI_cor,top_cai_cor,high_cai_cor,low_cai_cor,def_cai_cor,half_cai_cor,test_cai_cor,sep = '\t'),file = paste0
              ("/media/hp/disk1/DYY/reference/annotation/", 
                species,"/correlation_riboseq_bymCAI",exp,"/",name,"correlation_mCAI"),
  ...
  write.table(paste(CAI_cor,top_cai_cor,high_cai_cor,low_cai_cor,def_cai_cor,half_cai_cor,test_cai_cor,sep = '\t'),file = paste0
              ("/media/hp/disk1/DYY/reference/annotation/", 
                species,"/correlation_riboseq_bymCAI",exp,"/","allcor.txt"),append = T,quote = FALSE,
              row.names = F, col.names = F)
}

setwd(paste0("/media/hp/disk1/DYY/reference/annotation/",species,"/correlation_riboseq_bymCAI",exp,"/" ))

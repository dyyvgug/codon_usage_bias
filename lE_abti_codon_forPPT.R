...
setwd("G:\\学习专用\\tRNA\\Sc\\seqbackup\\aligned_tRNA_one")
...
#                labels = trans_format("log10", math_format(10^.x))) +
  scale_y_continuous(limits=c(10^1,10^3.5),trans=log10_trans(),labels = trans_format("log10", math_format(10^.x)))+
...
p1
ggsave(paste0(per,"_Sc_anticodon_forPPT.pdf"))

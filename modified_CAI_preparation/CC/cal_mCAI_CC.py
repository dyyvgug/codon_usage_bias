...
weight_path = '/media/hp/disk2/GO_KEGG/GO/{}/CC/'.format(args.spA)
fa_file = open(args.inp, 'r')
weight_file = open("{}CC_RSCU_weight.txt".format(weight_path), 'r')
CAI_file = open('{}_mCAI_CC.txt'.format(args.spA), 'w')

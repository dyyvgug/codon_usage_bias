...
hE_path = '/media/hp/disk2/DYY2/cell_line/HEK293/experiment1/'
hE = open('{}SRR3589956_high_exp_only_name.txt'.format(hE_path),'r')
hE_seq = open('{}SRR3589956_hE_seq.fa'.format(hE_path),'w')

#===========================================================================================================
# 2019-9-19.Modified date:2019-10-24.Author:Dong Yingying.Differences in codon frequency and RSCU value 
...
rownames(codon_RSCU) = codon_RSCU[,1]
codon_RSCU = codon_RSCU[,-c(1,2)]

pdf("40_codon_RSCU.pdf")

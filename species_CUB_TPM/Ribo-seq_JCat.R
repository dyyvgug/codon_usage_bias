...
dir.create(paste0("picture_riboseq_byJCAT",exp))
dir.create(paste0("correlation_riboseq_byJCAT",exp))
...
for (i in ribo_array) {
  ...
  svg(file=paste0("/media/hp/disk1/DYY/reference/annotation/", species,"/picture_riboseq_byJCAT",exp,"/",name,"_CAI_TPM.svg"))
  ...
  write.table(CAI_cor,file =  paste0
              ("/media/hp/disk1/DYY/reference/annotation/", species,
                "/correlation_riboseq_byJCAT",exp,"/","CAI_cor.txt"),append = T,quote = FALSE,
              row.names = F, col.names = F)
}
setwd(paste0("/media/hp/disk1/DYY/reference/annotation/",species,"/correlation_riboseq_byJCAT",exp,"/" ))

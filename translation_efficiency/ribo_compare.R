...
p <- boxplot(other_ribo_gene$RNA_TPM,hE_hT_ribo_gene$RNA_TPM,names=c('OTHER','hiEXPhiTRA'),col=c("green","red"))
dev.off()
png("40_compare_ribo_riboTPM.png")
p <- boxplot(other_ribo_gene$ribo_TPM,hE_hT_ribo_gene$ribo_TPM,names=c('OTHER','hiEXPhiTRA'),col=c("green","red"))
dev.off()

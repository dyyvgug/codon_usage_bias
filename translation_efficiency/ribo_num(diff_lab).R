#============================================================================================== 
# 2019-7-29.Modified date:2019-11-18.Author:Dong Yingying.Roughly  observe the translation efficiency.
...
#     xlab="RNA_TPM",ylab="ri_TPM",pch=19,col=rgb(0,0,100,50,maxColorValue=205))
  p <- ggplot(only_protein_num,aes(x = TPM ,y = ribo_TPM))+
    ...
    labs(title = paste0(name,'  ',"r=",round(co_RNA_ri,3),"  p-value < 2.2e-16"))+
    ...
    ylab('Ribo-seq TPM')+
    theme_classic()
pdf(paste0(name,"cor_RNA_ri.pdf"))
p
dev.off()
